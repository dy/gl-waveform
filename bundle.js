...
Waveform.prototype.push = function (samples) {
  ...
  if (typeof samples[0] !== 'number') {
    var _data = []; // normalize {x, y} objects to flat array
  ...
  for (var _i2 = 0, l = dataLen; _i2 < l; _i2++) {
    ...
    data[_i2 * ch + 3] = f32.fract(txt.sum2);
  }
...
Waveform.prototype.destroy = function () {
  ...
  this.textures.forEach(function (txt) {
    if (_this.storeData) pool.freeFloat(txt.data);
    txt.destroy();
  });
...
Waveform.prototype.storeData = true; // Texture size affects
